 ...
 * 
 */
public class ContextModelPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ContextModelPropertiesEditionPart {
	 ...
	 */
	public ContextModelPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ContextModelPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(MoSaRTBackEnd_AnalysisRepositoryMessages.ContextModelPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ContextModelPropertiesEditionPartForm.this,
							MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.name, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ContextModelPropertiesEditionPartForm.this,
							MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.description,
		...
		description.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.description, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createReferencesMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editReferences = widgetFactory.createButton(parent, getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.references, MoSaRTBackEnd_AnalysisRepositoryMessages.ContextModelPropertiesEditionPart_ReferencesLabel), SWT.NONE);
		...
		editReferences.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.references, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(referencesList)));
					setHasChanged(true);
				}
			}
		});
	 ...
	 * 
	 */
	protected Composite createFalseEvaluationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.falseEvaluation = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.falseEvaluation, MoSaRTBackEnd_AnalysisRepositoryMessages.ContextModelPropertiesEditionPart_FalseEvaluationLabel), new ReferencesTableListener	() {
		...
		this.falseEvaluation.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.falseEvaluation, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND));
		this.falseEvaluation.createControls(parent, widgetFactory);
		this.falseEvaluation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.falseEvaluation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"false Evaluation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.falseEvaluation,
	...
	protected void moveFalseEvaluation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.falseEvaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		falseEvaluation.refresh();
	}
	...
	protected void removeFromFalseEvaluation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.falseEvaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		falseEvaluation.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createTrueEvaluationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.trueEvaluation = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.trueEvaluation, MoSaRTBackEnd_AnalysisRepositoryMessages.ContextModelPropertiesEditionPart_TrueEvaluationLabel), new ReferencesTableListener	() {
		...
		this.trueEvaluation.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.trueEvaluation, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND));
		this.trueEvaluation.createControls(parent, widgetFactory);
		this.trueEvaluation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.trueEvaluation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addTrueEvaluation() {
		...
		"true Evaluation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.trueEvaluation,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveTrueEvaluation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.trueEvaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		trueEvaluation.refresh();
	}
	...
	protected void removeFromTrueEvaluation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.trueEvaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		trueEvaluation.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createUndefinedEvaluationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.undefinedEvaluation = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.undefinedEvaluation, MoSaRTBackEnd_AnalysisRepositoryMessages.ContextModelPropertiesEditionPart_UndefinedEvaluationLabel), new ReferencesTableListener	() {
		...
		this.undefinedEvaluation.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.undefinedEvaluation, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND));
		this.undefinedEvaluation.createControls(parent, widgetFactory);
		this.undefinedEvaluation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.undefinedEvaluation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addUndefinedEvaluation() {
		...
		"undefined Evaluation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.undefinedEvaluation,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveUndefinedEvaluation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.undefinedEvaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		undefinedEvaluation.refresh();
	}
	...
	protected void removeFromUndefinedEvaluation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.undefinedEvaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		undefinedEvaluation.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createAnalysisTestsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.analysisTests = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.analysisTests, MoSaRTBackEnd_AnalysisRepositoryMessages.ContextModelPropertiesEditionPart_AnalysisTestsLabel), new ReferencesTableListener	() {
		...
		this.analysisTests.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.analysisTests, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND));
		this.analysisTests.createControls(parent, widgetFactory);
		this.analysisTests.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.analysisTests, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addAnalysisTests() {
		...
		"analysisTests", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.analysisTests,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveAnalysisTests(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.analysisTests, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		analysisTests.refresh();
	}
	...
	protected void removeFromAnalysisTests(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContextModelPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ContextModel.Properties.analysisTests, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		analysisTests.refresh();
	}
