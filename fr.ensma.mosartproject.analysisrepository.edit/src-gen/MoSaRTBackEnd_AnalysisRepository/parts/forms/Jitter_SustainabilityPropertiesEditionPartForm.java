 ...
 * 
 */
public class Jitter_SustainabilityPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, Jitter_SustainabilityPropertiesEditionPart {
	 ...
	 */
	public Jitter_SustainabilityPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public Jitter_SustainabilityPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(MoSaRTBackEnd_AnalysisRepositoryMessages.Jitter_SustainabilityPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createContextsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.contexts = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.contexts, MoSaRTBackEnd_AnalysisRepositoryMessages.Jitter_SustainabilityPropertiesEditionPart_ContextsLabel), new ReferencesTableListener	() {
		...
		this.contexts.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.contexts, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND));
		...
		"contexts", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(Jitter_SustainabilityPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.contexts,
	...
	protected void moveContexts(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(Jitter_SustainabilityPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.contexts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		contexts.refresh();
	}
	...
	protected void removeFromContexts(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(Jitter_SustainabilityPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.contexts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		contexts.refresh();
	}
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, MoSaRTBackEnd_AnalysisRepositoryMessages.Jitter_SustainabilityPropertiesEditionPart_CommentLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.comment, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND));
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							Jitter_SustainabilityPropertiesEditionPartForm.this,
							MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.comment,
		...
		comment.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(Jitter_SustainabilityPropertiesEditionPartForm.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.Jitter_Sustainability.Properties.comment, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
