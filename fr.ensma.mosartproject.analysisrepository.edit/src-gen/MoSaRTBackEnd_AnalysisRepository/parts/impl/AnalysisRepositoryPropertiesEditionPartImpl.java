 ...
 * 
 */
public class AnalysisRepositoryPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AnalysisRepositoryPropertiesEditionPart {
	 ...
	 * 
	 */
	public AnalysisRepositoryPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.name, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.name, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.description, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.description, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createGeneralizationRelationshipsAdvancedTableComposition(Composite parent) {
		this.generalizationRelationships = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.generalizationRelationships, MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_GeneralizationRelationshipsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.generalizationRelationships, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				generalizationRelationships.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.generalizationRelationships, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				generalizationRelationships.refresh();
			}
		...
		this.generalizationRelationships.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.generalizationRelationships, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		this.generalizationRelationships.createControls(parent);
	 ...
	 * 
	 */
	protected Composite createContextModelsAdvancedTableComposition(Composite parent) {
		this.contextModels = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.contextModels, MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_ContextModelsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.contextModels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				contextModels.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.contextModels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				contextModels.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.contextModels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				contextModels.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.contextModels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				contextModels.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.contextModels.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.contextModels, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		this.contextModels.createControls(parent);
	 ...
	 * 
	 */
	protected Composite createIdentificationRulesAdvancedTableComposition(Composite parent) {
		this.identificationRules = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.identificationRules, MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_IdentificationRulesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.identificationRules, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				identificationRules.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.identificationRules, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				identificationRules.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.identificationRules, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				identificationRules.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.identificationRules, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				identificationRules.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.identificationRules.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.identificationRules, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		this.identificationRules.createControls(parent);
	 ...
	 * 
	 */
	protected Composite createAnalysisToolsAdvancedTableComposition(Composite parent) {
		this.analysisTools = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.analysisTools, MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_AnalysisToolsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.analysisTools, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				analysisTools.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.analysisTools, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				analysisTools.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.analysisTools, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				analysisTools.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.analysisTools, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				analysisTools.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.analysisTools.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.analysisTools, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		this.analysisTools.createControls(parent);
	 ...
	 * 
	 */
	protected Composite createMetaModelOfMoSaRTFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_MetaModelOfMoSaRTLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.metaModelOfMoSaRT, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		metaModelOfMoSaRT = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.metaModelOfMoSaRT, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		metaModelOfMoSaRT.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.metaModelOfMoSaRT, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getMetaModelOfMoSaRT()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.metaModelOfMoSaRT, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createTestFamiliesAdvancedTableComposition(Composite parent) {
		this.testFamilies = new ReferencesTable(getDescription(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.testFamilies, MoSaRTBackEnd_AnalysisRepositoryMessages.AnalysisRepositoryPropertiesEditionPart_TestFamiliesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.testFamilies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				testFamilies.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.testFamilies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				testFamilies.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.testFamilies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				testFamilies.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnalysisRepositoryPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.testFamilies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				testFamilies.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.testFamilies.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.AnalysisRepository.Properties.testFamilies, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		this.testFamilies.createControls(parent);
