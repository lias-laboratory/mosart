 ...
 * 
 */
public class ExecutionTime_SustainabilityPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ExecutionTime_SustainabilityPropertiesEditionPart {
	 ...
	 * 
	 */
	public ExecutionTime_SustainabilityPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(MoSaRTBackEnd_AnalysisRepositoryMessages.ExecutionTime_SustainabilityPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createCommentText(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.ExecutionTime_SustainabilityPropertiesEditionPart_CommentLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ExecutionTime_Sustainability.Properties.comment, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExecutionTime_SustainabilityPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ExecutionTime_Sustainability.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ExecutionTime_Sustainability.Properties.comment, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createContextsAdvancedReferencesTable(Composite parent) {
		String label = MoSaRTBackEnd_AnalysisRepositoryMessages.ExecutionTime_SustainabilityPropertiesEditionPart_ContextsLabel;
		...
		this.contexts.setHelpText(propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ExecutionTime_Sustainability.Properties.contexts, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		"contexts", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExecutionTime_SustainabilityPropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.ExecutionTime_Sustainability.Properties.contexts,
