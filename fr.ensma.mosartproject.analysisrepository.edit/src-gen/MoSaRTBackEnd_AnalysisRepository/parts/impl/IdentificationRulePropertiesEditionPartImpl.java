 ...
 * 
 */
public class IdentificationRulePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, IdentificationRulePropertiesEditionPart {
	 ...
	 * 
	 */
	public IdentificationRulePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(MoSaRTBackEnd_AnalysisRepositoryMessages.IdentificationRulePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIdText(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.IdentificationRulePropertiesEditionPart_IdLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.id, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IdentificationRulePropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.id, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createComponentKindEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.IdentificationRulePropertiesEditionPart_ComponentKindLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.componentKind, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		componentKind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IdentificationRulePropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.componentKind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getComponentKind()));
			}

		});
		componentKind.setID(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.componentKind);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.componentKind, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createTimingKindEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.IdentificationRulePropertiesEditionPart_TimingKindLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.timingKind, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		timingKind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IdentificationRulePropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.timingKind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTimingKind()));
			}

		});
		timingKind.setID(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.timingKind);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.timingKind, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRuleFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.IdentificationRulePropertiesEditionPart_RuleLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.rule, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		rule = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.rule, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		rule.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IdentificationRulePropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.rule, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRule()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.rule, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRuleContextFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.IdentificationRulePropertiesEditionPart_RuleContextLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.ruleContext, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		ruleContext = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.ruleContext, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		ruleContext.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IdentificationRulePropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.ruleContext, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRuleContext()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.ruleContext, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, MoSaRTBackEnd_AnalysisRepositoryMessages.IdentificationRulePropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.description, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IdentificationRulePropertiesEditionPartImpl.this, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MoSaRTBackEnd_AnalysisRepositoryViewsRepository.IdentificationRule.Properties.description, MoSaRTBackEnd_AnalysisRepositoryViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
