...
import MoSaRTBackEnd_AnalysisRepository.components.ToolPropertiesEditionComponent;
...
public class ToolPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Tool) 
					&& (MoSaRTBackEnd_AnalysisRepositoryPackage.Literals.TOOL == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && MoSaRTBackEnd_AnalysisRepositoryPackage.Literals.TOOL == eObj.eClass();
		}
