...
/**
 * This is the item provider adapter for a {@link MoSaRTBackEnd_AnalysisRepository.SufficientCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SufficientConditionItemProvider
	...
	public String getText(Object object) {
		String label = ((SufficientCondition)object).getTestValue();
		return label == null || label.length() == 0 ?
			getString("_UI_SufficientCondition_type") :
			getString("_UI_SufficientCondition_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SufficientCondition.class)) {
