...
public class UmlImporter1 extends AbstractExternalJavaAction { 
	ReusedMethod rm= new ReusedMethod();
/****************************can execute***********************************************/
	public boolean canExecute(Collection<? extends EObject> selections)
	  {
	   return true; // always ready to be executed
	  }
...
/*******************************Import******************************************************/
	  public void doImport() throws IOException 
		...
		if (sfs.getUmlModel() == null)
			...
			{
			rm.setErrorBox("Cannot import Uml Model, an Uml Model already exists","System Error");
			}
	  	}
	}
