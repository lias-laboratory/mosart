 ...
 */
package MoSaRT.FunctionalElements.parts.forms;
 ...
 * 
 */
public class SystemFunctionalSidePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SystemFunctionalSidePropertiesEditionPart {

	protected Text name;
	protected SingleCompositionEditor umlModel;
	 ...
	 */
	public SystemFunctionalSidePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public SystemFunctionalSidePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(systemFunctionalSideStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.umlModel) {
					return createUmlModelSingleCompositionEditor(parent, widgetFactory);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(FunctionalElementsMessages.SystemFunctionalSidePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SystemFunctionalSidePropertiesEditionPartForm.this,
							FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SystemFunctionalSidePropertiesEditionPartForm.this, FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.name, FunctionalElementsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createUmlModelSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		//create widget
		umlModel = new SingleCompositionEditor(widgetFactory, parent, SWT.NONE);
		...
		umlModel.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SystemFunctionalSidePropertiesEditionPartForm.this,  FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.umlModel, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				umlModel.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SystemFunctionalSidePropertiesEditionPartForm.this,  FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.umlModel, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				umlModel.refresh();
			}
		});
		umlModel.setID(FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.umlModel);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FunctionalElementsViewsRepository.SystemFunctionalSide.Properties.umlModel, FunctionalElementsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
