 ...
 * 
 */
public class HpCommunicationChannelPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, HpCommunicationChannelPropertiesEditionPart {
	 ...
	 * 
	 */
	public HpCommunicationChannelPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(hpCommunicationChannelStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.networkPort) {
					return createNetworkPortAdvancedReferencesTable(parent);
				}
				if (key == HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnitSet) {
					return createProcessingUnitSetAdvancedReferencesTable(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(HardwarePlatformMessages.HpCommunicationChannelPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.name, HardwarePlatformViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createProcessingUnitsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnits, HardwarePlatformMessages.HpCommunicationChannelPropertiesEditionPart_ProcessingUnitsLabel);		 
		...
		this.processingUnits.setHelpText(propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnits, HardwarePlatformViewsRepository.SWT_KIND));
		...
		this.processingUnits.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnits, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"processingUnits", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnits,
	...
	protected void moveProcessingUnits(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnits, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		processingUnits.refresh();
	}
	...
	protected void removeFromProcessingUnits(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnits, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		processingUnits.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createNetworkPortAdvancedReferencesTable(Composite parent) {
		String label = getDescription(HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.networkPort, HardwarePlatformMessages.HpCommunicationChannelPropertiesEditionPart_NetworkPortLabel);		 
		this.networkPort = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.networkPort.setHelpText(propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.networkPort, HardwarePlatformViewsRepository.SWT_KIND));
		this.networkPort.createControls(parent);
		this.networkPort.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.networkPort, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addNetworkPort() {
		...
		"networkPort", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.networkPort,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				networkPort.refresh();
			}
	...
	protected void moveNetworkPort(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.networkPort, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		networkPort.refresh();
	}
	...
	protected void removeFromNetworkPort(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.networkPort, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		networkPort.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createProcessingUnitSetAdvancedReferencesTable(Composite parent) {
		String label = getDescription(HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnitSet, HardwarePlatformMessages.HpCommunicationChannelPropertiesEditionPart_ProcessingUnitSetLabel);		 
		this.processingUnitSet = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.processingUnitSet.setHelpText(propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnitSet, HardwarePlatformViewsRepository.SWT_KIND));
		this.processingUnitSet.createControls(parent);
	...
	protected void addProcessingUnitSet() {
		...
		"processingUnitSet", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnitSet,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveProcessingUnitSet(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnitSet, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		processingUnitSet.refresh();
	}
	...
	protected void removeFromProcessingUnitSet(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpCommunicationChannelPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpCommunicationChannel.Properties.processingUnitSet, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		processingUnitSet.refresh();
	}
