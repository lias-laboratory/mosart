 ...
 * 
 */
public class HpProcessingUnitPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, HpProcessingUnitPropertiesEditionPart {
	...
	private SingleCompositionEditor rtpUtilizationFactor;
	private SingleCompositionEditor rtpComputingSpeed;
	 ...
	 * 
	 */
	public HpProcessingUnitPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(hpProcessingUnitStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == HardwarePlatformViewsRepository.HpProcessingUnit.Properties.spaceProcesses) {
					return createSpaceProcessesAdvancedReferencesTable(parent);
				}
				if (key == HardwarePlatformViewsRepository.HpProcessingUnit.Properties.candidateTasks) {
					return createCandidateTasksAdvancedReferencesTable(parent);
				}
				...
				if (key == HardwarePlatformViewsRepository.HpProcessingUnit.Properties.processorInterconnector) {
					return createProcessorInterconnectorFlatComboViewer(parent);
				}
				if (key == HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpUtilizationFactor) {
					return createRtpUtilizationFactorSingleCompositionEditor(parent);
				}
				if (key == HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpComputingSpeed) {
					return createRtpComputingSpeedSingleCompositionEditor(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(HardwarePlatformMessages.HpProcessingUnitPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.name, HardwarePlatformViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCommChannelFlatComboViewer(Composite parent) {
		...
		commChannel = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.commChannel, HardwarePlatformViewsRepository.SWT_KIND));
		...
		commChannel.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.commChannel, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getCommChannel()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.commChannel, HardwarePlatformViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createSpaceProcessesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.spaceProcesses, HardwarePlatformMessages.HpProcessingUnitPropertiesEditionPart_SpaceProcessesLabel);		 
		this.spaceProcesses = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.spaceProcesses.setHelpText(propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.spaceProcesses, HardwarePlatformViewsRepository.SWT_KIND));
		this.spaceProcesses.createControls(parent);
		this.spaceProcesses.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.spaceProcesses, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"spaceProcesses", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.spaceProcesses,
	...
	protected void moveSpaceProcesses(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.spaceProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		spaceProcesses.refresh();
	}
	...
	protected void removeFromSpaceProcesses(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.spaceProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		spaceProcesses.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createCandidateTasksAdvancedReferencesTable(Composite parent) {
		String label = getDescription(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.candidateTasks, HardwarePlatformMessages.HpProcessingUnitPropertiesEditionPart_CandidateTasksLabel);		 
		this.candidateTasks = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.candidateTasks.setHelpText(propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.candidateTasks, HardwarePlatformViewsRepository.SWT_KIND));
		this.candidateTasks.createControls(parent);
		this.candidateTasks.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.candidateTasks, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCandidateTasks() {
		...
		"candidateTasks", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.candidateTasks,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveCandidateTasks(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.candidateTasks, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		candidateTasks.refresh();
	}
	...
	protected void removeFromCandidateTasks(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.candidateTasks, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		candidateTasks.refresh();
	}
	...
	protected Composite createSchedulableTasksAdvancedReferencesTable(Composite parent) {
		String label = getDescription(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.schedulableTasks, HardwarePlatformMessages.HpProcessingUnitPropertiesEditionPart_SchedulableTasksLabel);		 
		...
		this.schedulableTasks.setHelpText(propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.schedulableTasks, HardwarePlatformViewsRepository.SWT_KIND));
		this.schedulableTasks.createControls(parent);
		this.schedulableTasks.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.schedulableTasks, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSchedulableTasks() {
		...
		"schedulableTasks", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.schedulableTasks,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveSchedulableTasks(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.schedulableTasks, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		schedulableTasks.refresh();
	}
	...
	protected void removeFromSchedulableTasks(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.schedulableTasks, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		schedulableTasks.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createProcessorInterconnectorFlatComboViewer(Composite parent) {
		...
		processorInterconnector = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.processorInterconnector, HardwarePlatformViewsRepository.SWT_KIND));
		...
		processorInterconnector.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this, HardwarePlatformViewsRepository.HpProcessingUnit.Properties.processorInterconnector, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getProcessorInterconnector()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.processorInterconnector, HardwarePlatformViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpUtilizationFactorSingleCompositionEditor(Composite parent) {
		...
		//create widget
		rtpUtilizationFactor = new SingleCompositionEditor(parent, SWT.NONE);
		...
		rtpUtilizationFactor.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this,  HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpUtilizationFactor, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpUtilizationFactor.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this,  HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpUtilizationFactor, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpUtilizationFactor.refresh();
			}
		});
		rtpUtilizationFactor.setID(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpUtilizationFactor);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpUtilizationFactor, HardwarePlatformViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpComputingSpeedSingleCompositionEditor(Composite parent) {
		...
		//create widget
		rtpComputingSpeed = new SingleCompositionEditor(parent, SWT.NONE);
		...
		rtpComputingSpeed.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this,  HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpComputingSpeed, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpComputingSpeed.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HpProcessingUnitPropertiesEditionPartImpl.this,  HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpComputingSpeed, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpComputingSpeed.refresh();
			}
		});
		rtpComputingSpeed.setID(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpComputingSpeed);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(HardwarePlatformViewsRepository.HpProcessingUnit.Properties.rtpComputingSpeed, HardwarePlatformViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
