 ...
 * 
 */
public class RtpComputationAndAnalysisFunctionsMessages extends NLS {
	
	private static final String BUNDLE_NAME = "MoSaRT.RealTimeProperties.RtpComputationAndAnalysisFunctions.providers.rtpComputationAndAnalysisFunctionsMessages"; //$NON-NLS-1$

	
	public static String WeibullComputationFunctionPropertiesEditionPart_PropertiesGroupLabel;


	
	public static String WeibullComputationFunction_ReadOnly;

	
	public static String WeibullComputationFunction_Part_Title;


	
	public static String WeibullComputationFunctionPropertiesEditionPart_FunctionTypeLabel;

	
	public static String WeibullComputationFunctionPropertiesEditionPart_ParametersLabel;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, RtpComputationAndAnalysisFunctionsMessages.class);
	}

	
	private RtpComputationAndAnalysisFunctionsMessages() {
