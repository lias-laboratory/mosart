 ...
 * 
 */
public class RtpDataSizeTypePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RtpDataSizeTypePropertiesEditionPart {
	 ...
	 */
	public RtpDataSizeTypePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public RtpDataSizeTypePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpHelperTypesMessages.RtpDataSizeTypePropertiesEditionPart_PropertiesGroupLabel);
		...
		unit.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpDataSizeTypePropertiesEditionPartForm.this, RtpHelperTypesViewsRepository.RtpDataSizeType.Properties.unit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getUnit()));
			}

		});
		unit.setID(RtpHelperTypesViewsRepository.RtpDataSizeType.Properties.unit);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpHelperTypesViewsRepository.RtpDataSizeType.Properties.unit, RtpHelperTypesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createValueSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		value.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpDataSizeTypePropertiesEditionPartForm.this,  RtpHelperTypesViewsRepository.RtpDataSizeType.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				value.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpDataSizeTypePropertiesEditionPartForm.this,  RtpHelperTypesViewsRepository.RtpDataSizeType.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				value.refresh();
			}
		});
		value.setID(RtpHelperTypesViewsRepository.RtpDataSizeType.Properties.value);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpHelperTypesViewsRepository.RtpDataSizeType.Properties.value, RtpHelperTypesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
