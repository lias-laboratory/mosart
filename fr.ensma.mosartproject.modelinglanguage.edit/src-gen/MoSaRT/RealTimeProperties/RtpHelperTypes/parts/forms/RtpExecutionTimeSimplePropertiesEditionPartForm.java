 ...
 * 
 */
public class RtpExecutionTimeSimplePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RtpExecutionTimeSimplePropertiesEditionPart {
	 ...
	 */
	public RtpExecutionTimeSimplePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public RtpExecutionTimeSimplePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpHelperTypesMessages.RtpExecutionTimeSimplePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RtpExecutionTimeSimplePropertiesEditionPartForm.this,
							RtpHelperTypesViewsRepository.RtpExecutionTimeSimple.Properties.value,
		...
		value.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpExecutionTimeSimplePropertiesEditionPartForm.this, RtpHelperTypesViewsRepository.RtpExecutionTimeSimple.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, value.getText()));
				}
			}
		});
		EditingUtils.setID(value, RtpHelperTypesViewsRepository.RtpExecutionTimeSimple.Properties.value);
		EditingUtils.setEEFtype(value, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpHelperTypesViewsRepository.RtpExecutionTimeSimple.Properties.value, RtpHelperTypesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
