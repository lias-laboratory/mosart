 ...
 * 
 */
public class RtpExecutionTimeListPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RtpExecutionTimeListPropertiesEditionPart {

	private SingleCompositionEditor vector;
	 ...
	 * 
	 */
	public RtpExecutionTimeListPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(rtpExecutionTimeListStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RtpHelperTypesViewsRepository.RtpExecutionTimeList.Properties.vector) {
					return createVectorSingleCompositionEditor(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpHelperTypesMessages.RtpExecutionTimeListPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createVectorSingleCompositionEditor(Composite parent) {
		...
		//create widget
		vector = new SingleCompositionEditor(parent, SWT.NONE);
		...
		vector.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpExecutionTimeListPropertiesEditionPartImpl.this,  RtpHelperTypesViewsRepository.RtpExecutionTimeList.Properties.vector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				vector.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpExecutionTimeListPropertiesEditionPartImpl.this,  RtpHelperTypesViewsRepository.RtpExecutionTimeList.Properties.vector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				vector.refresh();
			}
		});
		vector.setID(RtpHelperTypesViewsRepository.RtpExecutionTimeList.Properties.vector);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpHelperTypesViewsRepository.RtpExecutionTimeList.Properties.vector, RtpHelperTypesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
