 ...
 */
package MoSaRT.RealTimeProperties.RtpMeasurementUnits.providers;
 ...
 * 
 */
public class RtpMeasurementUnitsMessages extends NLS {
	
	private static final String BUNDLE_NAME = "MoSaRT.RealTimeProperties.RtpMeasurementUnits.providers.rtpMeasurementUnitsMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, RtpMeasurementUnitsMessages.class);
	}

	
	private RtpMeasurementUnitsMessages() {
