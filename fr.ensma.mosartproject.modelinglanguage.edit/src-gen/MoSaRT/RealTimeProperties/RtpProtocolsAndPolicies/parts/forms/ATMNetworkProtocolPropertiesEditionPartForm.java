 ...
 * 
 */
public class ATMNetworkProtocolPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ATMNetworkProtocolPropertiesEditionPart {
	 ...
	 */
	public ATMNetworkProtocolPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ATMNetworkProtocolPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpProtocolsAndPoliciesMessages.ATMNetworkProtocolPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createProtocolTypeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ATMNetworkProtocolPropertiesEditionPartForm.this,
							RtpProtocolsAndPoliciesViewsRepository.ATMNetworkProtocol.Properties.protocolType,
		...
		protocolType.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ATMNetworkProtocolPropertiesEditionPartForm.this, RtpProtocolsAndPoliciesViewsRepository.ATMNetworkProtocol.Properties.protocolType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, protocolType.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.ATMNetworkProtocol.Properties.protocolType, RtpProtocolsAndPoliciesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
