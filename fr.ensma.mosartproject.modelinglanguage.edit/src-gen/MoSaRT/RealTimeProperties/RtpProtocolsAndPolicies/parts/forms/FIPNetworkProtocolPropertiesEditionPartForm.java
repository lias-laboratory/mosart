 ...
 * 
 */
public class FIPNetworkProtocolPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FIPNetworkProtocolPropertiesEditionPart {
	 ...
	 */
	public FIPNetworkProtocolPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public FIPNetworkProtocolPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpProtocolsAndPoliciesMessages.FIPNetworkProtocolPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createProtocolTypeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							FIPNetworkProtocolPropertiesEditionPartForm.this,
							RtpProtocolsAndPoliciesViewsRepository.FIPNetworkProtocol.Properties.protocolType,
		...
		protocolType.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FIPNetworkProtocolPropertiesEditionPartForm.this, RtpProtocolsAndPoliciesViewsRepository.FIPNetworkProtocol.Properties.protocolType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, protocolType.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.FIPNetworkProtocol.Properties.protocolType, RtpProtocolsAndPoliciesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
