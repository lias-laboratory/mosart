 ...
 * 
 */
public class FullDuplexTransmissionModePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FullDuplexTransmissionModePropertiesEditionPart {
	 ...
	 */
	public FullDuplexTransmissionModePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public FullDuplexTransmissionModePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpProtocolsAndPoliciesMessages.FullDuplexTransmissionModePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createModeTypeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							FullDuplexTransmissionModePropertiesEditionPartForm.this,
							RtpProtocolsAndPoliciesViewsRepository.FullDuplexTransmissionMode.Properties.modeType,
		...
		modeType.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FullDuplexTransmissionModePropertiesEditionPartForm.this, RtpProtocolsAndPoliciesViewsRepository.FullDuplexTransmissionMode.Properties.modeType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, modeType.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.FullDuplexTransmissionMode.Properties.modeType, RtpProtocolsAndPoliciesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
