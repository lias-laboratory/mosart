 ...
 * 
 */
public class HomogeneousMultiprocessorCategoryPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, HomogeneousMultiprocessorCategoryPropertiesEditionPart {
	 ...
	 */
	public HomogeneousMultiprocessorCategoryPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public HomogeneousMultiprocessorCategoryPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpProtocolsAndPoliciesMessages.HomogeneousMultiprocessorCategoryPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createCategoryTypeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							HomogeneousMultiprocessorCategoryPropertiesEditionPartForm.this,
							RtpProtocolsAndPoliciesViewsRepository.HomogeneousMultiprocessorCategory.Properties.categoryType,
		...
		categoryType.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HomogeneousMultiprocessorCategoryPropertiesEditionPartForm.this, RtpProtocolsAndPoliciesViewsRepository.HomogeneousMultiprocessorCategory.Properties.categoryType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, categoryType.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.HomogeneousMultiprocessorCategory.Properties.categoryType, RtpProtocolsAndPoliciesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
