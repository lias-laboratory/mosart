 ...
 * 
 */
public class ICPPProtectProtocolPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ICPPProtectProtocolPropertiesEditionPart {
	 ...
	 */
	public ICPPProtectProtocolPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ICPPProtectProtocolPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpProtocolsAndPoliciesMessages.ICPPProtectProtocolPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createProtocolTypeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ICPPProtectProtocolPropertiesEditionPartForm.this,
							RtpProtocolsAndPoliciesViewsRepository.ICPPProtectProtocol.Properties.protocolType,
		...
		protocolType.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ICPPProtectProtocolPropertiesEditionPartForm.this, RtpProtocolsAndPoliciesViewsRepository.ICPPProtectProtocol.Properties.protocolType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, protocolType.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.ICPPProtectProtocol.Properties.protocolType, RtpProtocolsAndPoliciesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
