 ...
 * 
 */
public class PriorityWaitingQueuePolicyPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, PriorityWaitingQueuePolicyPropertiesEditionPart {
	 ...
	 */
	public PriorityWaitingQueuePolicyPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public PriorityWaitingQueuePolicyPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpProtocolsAndPoliciesMessages.PriorityWaitingQueuePolicyPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPolicyTypeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PriorityWaitingQueuePolicyPropertiesEditionPartForm.this,
							RtpProtocolsAndPoliciesViewsRepository.PriorityWaitingQueuePolicy.Properties.policyType,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.PriorityWaitingQueuePolicy.Properties.policyType, RtpProtocolsAndPoliciesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
