 ...
 * 
 */
public class CANNetworkProtocolPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CANNetworkProtocolPropertiesEditionPart {
	 ...
	 * 
	 */
	public CANNetworkProtocolPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpProtocolsAndPoliciesMessages.CANNetworkProtocolPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createProtocolTypeText(Composite parent) {
		...
		protocolType.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CANNetworkProtocolPropertiesEditionPartImpl.this, RtpProtocolsAndPoliciesViewsRepository.CANNetworkProtocol.Properties.protocolType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, protocolType.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.CANNetworkProtocol.Properties.protocolType, RtpProtocolsAndPoliciesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
