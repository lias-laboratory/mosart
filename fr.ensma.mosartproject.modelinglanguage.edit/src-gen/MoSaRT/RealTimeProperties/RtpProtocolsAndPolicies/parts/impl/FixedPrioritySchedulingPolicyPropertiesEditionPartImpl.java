 ...
 * 
 */
public class FixedPrioritySchedulingPolicyPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, FixedPrioritySchedulingPolicyPropertiesEditionPart {
	 ...
	 * 
	 */
	public FixedPrioritySchedulingPolicyPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpProtocolsAndPoliciesMessages.FixedPrioritySchedulingPolicyPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPolicyTypeText(Composite parent) {
		...
		policyType.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FixedPrioritySchedulingPolicyPropertiesEditionPartImpl.this, RtpProtocolsAndPoliciesViewsRepository.FixedPrioritySchedulingPolicy.Properties.policyType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, policyType.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.FixedPrioritySchedulingPolicy.Properties.policyType, RtpProtocolsAndPoliciesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
