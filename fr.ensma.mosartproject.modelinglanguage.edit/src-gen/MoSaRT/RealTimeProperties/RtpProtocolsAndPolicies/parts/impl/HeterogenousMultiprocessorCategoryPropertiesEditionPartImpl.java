 ...
 * 
 */
public class HeterogenousMultiprocessorCategoryPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, HeterogenousMultiprocessorCategoryPropertiesEditionPart {
	 ...
	 * 
	 */
	public HeterogenousMultiprocessorCategoryPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpProtocolsAndPoliciesMessages.HeterogenousMultiprocessorCategoryPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createCategoryTypeText(Composite parent) {
		...
		categoryType.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HeterogenousMultiprocessorCategoryPropertiesEditionPartImpl.this, RtpProtocolsAndPoliciesViewsRepository.HeterogenousMultiprocessorCategory.Properties.categoryType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, categoryType.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.HeterogenousMultiprocessorCategory.Properties.categoryType, RtpProtocolsAndPoliciesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
