 ...
 * 
 */
public class LeastLaxityFirstSchedulingPolicyPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, LeastLaxityFirstSchedulingPolicyPropertiesEditionPart {
	 ...
	 * 
	 */
	public LeastLaxityFirstSchedulingPolicyPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpProtocolsAndPoliciesMessages.LeastLaxityFirstSchedulingPolicyPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPolicyTypeText(Composite parent) {
		...
		policyType.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LeastLaxityFirstSchedulingPolicyPropertiesEditionPartImpl.this, RtpProtocolsAndPoliciesViewsRepository.LeastLaxityFirstSchedulingPolicy.Properties.policyType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, policyType.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.LeastLaxityFirstSchedulingPolicy.Properties.policyType, RtpProtocolsAndPoliciesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
