 ...
 * 
 */
public class PIPProtectProtocolPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PIPProtectProtocolPropertiesEditionPart {
	 ...
	 * 
	 */
	public PIPProtectProtocolPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpProtocolsAndPoliciesMessages.PIPProtectProtocolPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createProtocolTypeText(Composite parent) {
		...
		protocolType.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PIPProtectProtocolPropertiesEditionPartImpl.this, RtpProtocolsAndPoliciesViewsRepository.PIPProtectProtocol.Properties.protocolType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, protocolType.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.PIPProtectProtocol.Properties.protocolType, RtpProtocolsAndPoliciesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
