 ...
 * 
 */
public class RestrictedMigrationTaskAllocationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RestrictedMigrationTaskAllocationPropertiesEditionPart {
	 ...
	 * 
	 */
	public RestrictedMigrationTaskAllocationPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpProtocolsAndPoliciesMessages.RestrictedMigrationTaskAllocationPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createAllocationTypeText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpProtocolsAndPoliciesViewsRepository.RestrictedMigrationTaskAllocation.Properties.allocationType, RtpProtocolsAndPoliciesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
