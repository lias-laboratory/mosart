 ...
 * 
 */
public class RtpPriorityTypePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public RtpPriorityTypePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject rtpPriorityType, String editing_mode) {
		super(editingContext, rtpPriorityType, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = RtpTypesViewsRepository.class;
		partKey = RtpTypesViewsRepository.RtpPriorityType.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final RtpPriorityType rtpPriorityType = (RtpPriorityType)elt;
			final RtpPriorityTypePropertiesEditionPart basePart = (RtpPriorityTypePropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(RtpTypesViewsRepository.RtpPriorityType.Properties.value)) {
				// init part
				valueSettings = new EObjectFlatComboSettings(rtpPriorityType, RtpTypesPackage.eINSTANCE.getRtpPriorityType_Value());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == RtpTypesViewsRepository.RtpPriorityType.Properties.value) {
			return RtpTypesPackage.eINSTANCE.getRtpPriorityType_Value();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		RtpPriorityType rtpPriorityType = (RtpPriorityType)semanticObject;
		if (RtpTypesViewsRepository.RtpPriorityType.Properties.value == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			RtpPriorityTypePropertiesEditionPart basePart = (RtpPriorityTypePropertiesEditionPart)editingPart;
			if (RtpTypesPackage.eINSTANCE.getRtpPriorityType_Value().equals(msg.getFeature()) && basePart != null && isAccessible(RtpTypesViewsRepository.RtpPriorityType.Properties.value))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			RtpTypesPackage.eINSTANCE.getRtpPriorityType_Value()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == RtpTypesViewsRepository.RtpPriorityType.Properties.value;
	}
