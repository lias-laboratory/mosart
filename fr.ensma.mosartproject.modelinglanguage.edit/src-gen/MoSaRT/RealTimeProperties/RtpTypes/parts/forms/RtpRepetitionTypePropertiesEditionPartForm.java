 ...
 * 
 */
public class RtpRepetitionTypePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RtpRepetitionTypePropertiesEditionPart {
	 ...
	 */
	public RtpRepetitionTypePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public RtpRepetitionTypePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(rtpRepetitionTypeStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RtpTypesViewsRepository.RtpRepetitionType.Properties.repetition) {
					return createRepetitionText(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpTypesMessages.RtpRepetitionTypePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createRepetitionText(FormToolkit widgetFactory, Composite parent) {
		...
		repetition = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		repetition.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RtpRepetitionTypePropertiesEditionPartForm.this,
							RtpTypesViewsRepository.RtpRepetitionType.Properties.repetition,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, repetition.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									RtpRepetitionTypePropertiesEditionPartForm.this,
									RtpTypesViewsRepository.RtpRepetitionType.Properties.repetition,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, repetition.getText()));
				}
			}
		...
		repetition.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpRepetitionTypePropertiesEditionPartForm.this, RtpTypesViewsRepository.RtpRepetitionType.Properties.repetition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, repetition.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RtpTypesViewsRepository.RtpRepetitionType.Properties.repetition, RtpTypesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
