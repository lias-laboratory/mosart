 ...
 * 
 */
public class RtpCriticalityTypePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RtpCriticalityTypePropertiesEditionPart {
	 ...
	 * 
	 */
	public RtpCriticalityTypePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpTypesMessages.RtpCriticalityTypePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createValueSingleCompositionEditor(Composite parent) {
		...
		value.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpCriticalityTypePropertiesEditionPartImpl.this,  RtpTypesViewsRepository.RtpCriticalityType.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				value.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpCriticalityTypePropertiesEditionPartImpl.this,  RtpTypesViewsRepository.RtpCriticalityType.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				value.refresh();
			}
		});
		value.setID(RtpTypesViewsRepository.RtpCriticalityType.Properties.value);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpTypesViewsRepository.RtpCriticalityType.Properties.value, RtpTypesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
