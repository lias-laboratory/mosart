 ...
 * 
 */
public class RtpResponseTimeTypePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RtpResponseTimeTypePropertiesEditionPart {

	private SingleCompositionEditor responseTime;
	 ...
	 * 
	 */
	public RtpResponseTimeTypePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(rtpResponseTimeTypeStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RtpTypesViewsRepository.RtpResponseTimeType.Properties.responseTime) {
					return createResponseTimeSingleCompositionEditor(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpTypesMessages.RtpResponseTimeTypePropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createResponseTimeSingleCompositionEditor(Composite parent) {
		...
		//create widget
		responseTime = new SingleCompositionEditor(parent, SWT.NONE);
		...
		responseTime.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpResponseTimeTypePropertiesEditionPartImpl.this,  RtpTypesViewsRepository.RtpResponseTimeType.Properties.responseTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				responseTime.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RtpResponseTimeTypePropertiesEditionPartImpl.this,  RtpTypesViewsRepository.RtpResponseTimeType.Properties.responseTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				responseTime.refresh();
			}
		});
		responseTime.setID(RtpTypesViewsRepository.RtpResponseTimeType.Properties.responseTime);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RtpTypesViewsRepository.RtpResponseTimeType.Properties.responseTime, RtpTypesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
