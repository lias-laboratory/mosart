 ...
 * 
 */
public class RealListPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RealListPropertiesEditionPart {
	 ...
	 */
	public RealListPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public RealListPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpUtilityTypesMessages.RealListPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createListElementsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editListElements = widgetFactory.createButton(parent, getDescription(RtpUtilityTypesViewsRepository.RealList.Properties.listElements, RtpUtilityTypesMessages.RealListPropertiesEditionPart_ListElementsLabel), SWT.NONE);
		...
		editListElements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealListPropertiesEditionPartForm.this, RtpUtilityTypesViewsRepository.RealList.Properties.listElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(listElementsList)));
					setHasChanged(true);
				}
			}
		});
