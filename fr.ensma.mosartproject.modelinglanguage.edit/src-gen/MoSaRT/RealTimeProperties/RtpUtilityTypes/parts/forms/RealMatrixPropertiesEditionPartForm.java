 ...
 * 
 */
public class RealMatrixPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RealMatrixPropertiesEditionPart {
	 ...
	 */
	public RealMatrixPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public RealMatrixPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RtpUtilityTypesMessages.RealMatrixPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createMatrixElementsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.matrixElements = new ReferencesTable(getDescription(RtpUtilityTypesViewsRepository.RealMatrix.Properties.matrixElements, RtpUtilityTypesMessages.RealMatrixPropertiesEditionPart_MatrixElementsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealMatrixPropertiesEditionPartForm.this, RtpUtilityTypesViewsRepository.RealMatrix.Properties.matrixElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				matrixElements.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealMatrixPropertiesEditionPartForm.this, RtpUtilityTypesViewsRepository.RealMatrix.Properties.matrixElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				matrixElements.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealMatrixPropertiesEditionPartForm.this, RtpUtilityTypesViewsRepository.RealMatrix.Properties.matrixElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				matrixElements.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealMatrixPropertiesEditionPartForm.this, RtpUtilityTypesViewsRepository.RealMatrix.Properties.matrixElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				matrixElements.refresh();
			}
		...
		this.matrixElements.setHelpText(propertiesEditionComponent.getHelpContent(RtpUtilityTypesViewsRepository.RealMatrix.Properties.matrixElements, RtpUtilityTypesViewsRepository.FORM_KIND));
		...
		this.matrixElements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealMatrixPropertiesEditionPartForm.this, RtpUtilityTypesViewsRepository.RealMatrix.Properties.matrixElements, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
