 ...
 * 
 */
public class IntegerListPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, IntegerListPropertiesEditionPart {
	 ...
	 * 
	 */
	public IntegerListPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpUtilityTypesMessages.IntegerListPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createListElementsMultiValuedEditor(Composite parent) {
		...
		editListElements.setText(getDescription(RtpUtilityTypesViewsRepository.IntegerList.Properties.listElements, RtpUtilityTypesMessages.IntegerListPropertiesEditionPart_ListElementsLabel));
		...
		editListElements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerListPropertiesEditionPartImpl.this, RtpUtilityTypesViewsRepository.IntegerList.Properties.listElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(listElementsList)));
					setHasChanged(true);
				}
			}
		});
