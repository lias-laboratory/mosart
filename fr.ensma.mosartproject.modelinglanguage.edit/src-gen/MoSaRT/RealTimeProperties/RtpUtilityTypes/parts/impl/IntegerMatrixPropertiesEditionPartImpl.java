 ...
 * 
 */
public class IntegerMatrixPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, IntegerMatrixPropertiesEditionPart {
	 ...
	 * 
	 */
	public IntegerMatrixPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(RtpUtilityTypesMessages.IntegerMatrixPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createMatrixElementsAdvancedTableComposition(Composite parent) {
		this.matrixElements = new ReferencesTable(getDescription(RtpUtilityTypesViewsRepository.IntegerMatrix.Properties.matrixElements, RtpUtilityTypesMessages.IntegerMatrixPropertiesEditionPart_MatrixElementsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerMatrixPropertiesEditionPartImpl.this, RtpUtilityTypesViewsRepository.IntegerMatrix.Properties.matrixElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				matrixElements.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerMatrixPropertiesEditionPartImpl.this, RtpUtilityTypesViewsRepository.IntegerMatrix.Properties.matrixElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				matrixElements.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerMatrixPropertiesEditionPartImpl.this, RtpUtilityTypesViewsRepository.IntegerMatrix.Properties.matrixElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				matrixElements.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerMatrixPropertiesEditionPartImpl.this, RtpUtilityTypesViewsRepository.IntegerMatrix.Properties.matrixElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				matrixElements.refresh();
			}
		...
		this.matrixElements.setHelpText(propertiesEditionComponent.getHelpContent(RtpUtilityTypesViewsRepository.IntegerMatrix.Properties.matrixElements, RtpUtilityTypesViewsRepository.SWT_KIND));
		this.matrixElements.createControls(parent);
		this.matrixElements.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerMatrixPropertiesEditionPartImpl.this, RtpUtilityTypesViewsRepository.IntegerMatrix.Properties.matrixElements, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
