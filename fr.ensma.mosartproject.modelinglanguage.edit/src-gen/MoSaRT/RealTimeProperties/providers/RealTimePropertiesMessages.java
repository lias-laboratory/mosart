 ...
 */
package MoSaRT.RealTimeProperties.providers;
 ...
 * 
 */
public class RealTimePropertiesMessages extends NLS {
	
	private static final String BUNDLE_NAME = "MoSaRT.RealTimeProperties.providers.realTimePropertiesMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, RealTimePropertiesMessages.class);
	}

	
	private RealTimePropertiesMessages() {
