 ...
 * 
 */
public class SbWriteStepPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public SbWriteStepPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject sbWriteStep, String editing_mode) {
		super(editingContext, sbWriteStep, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = SoftwareBehaviorViewsRepository.class;
		partKey = SoftwareBehaviorViewsRepository.SbWriteStep.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final SbWriteStep sbWriteStep = (SbWriteStep)elt;
			final SbWriteStepPropertiesEditionPart basePart = (SbWriteStepPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, sbWriteStep.getName()));
			
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation)) {
				inputStepRelationSettings = new ReferencesTableSettings(sbWriteStep, SoftwareBehaviorPackage.eINSTANCE.getSbStep_InputStepRelation());
				basePart.initInputStepRelation(inputStepRelationSettings);
			}
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation)) {
				outputStepRelationSettings = new ReferencesTableSettings(sbWriteStep, SoftwareBehaviorPackage.eINSTANCE.getSbStep_OutputStepRelation());
				basePart.initOutputStepRelation(outputStepRelationSettings);
			}
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.representedOperation)) {
				// init part
				representedOperationSettings = new EObjectFlatComboSettings(sbWriteStep, SoftwareBehaviorPackage.eINSTANCE.getSbStep_RepresentedOperation());
			...
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.interactionResource)) {
				// init part
				interactionResourceSettings = new EObjectFlatComboSettings(sbWriteStep, SoftwareBehaviorPackage.eINSTANCE.getSbStep_InteractionResource());
			...
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpExecutionTime)) {
				// init part
				rtpExecutionTimeSettings = new EObjectFlatComboSettings(sbWriteStep, SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpExecutionTime());
				basePart.initRtpExecutionTime(rtpExecutionTimeSettings);
			}
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpDeadline)) {
				// init part
				rtpDeadlineSettings = new EObjectFlatComboSettings(sbWriteStep, SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpDeadline());
				basePart.initRtpDeadline(rtpDeadlineSettings);
			}
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpBlockingTime)) {
				// init part
				rtpBlockingTimeSettings = new EObjectFlatComboSettings(sbWriteStep, SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpBlockingTime());
				basePart.initRtpBlockingTime(rtpBlockingTimeSettings);
			}
			if (isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpRepetition)) {
				// init part
				rtpRepetitionSettings = new EObjectFlatComboSettings(sbWriteStep, SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpRepetition());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.name) {
			return SoftwareBehaviorPackage.eINSTANCE.getSbStep_Name();
		}
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation) {
			return SoftwareBehaviorPackage.eINSTANCE.getSbStep_InputStepRelation();
		}
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation) {
			return SoftwareBehaviorPackage.eINSTANCE.getSbStep_OutputStepRelation();
		}
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.representedOperation) {
			return SoftwareBehaviorPackage.eINSTANCE.getSbStep_RepresentedOperation();
		}
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.interactionResource) {
			return SoftwareBehaviorPackage.eINSTANCE.getSbStep_InteractionResource();
		}
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpExecutionTime) {
			return SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpExecutionTime();
		}
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpDeadline) {
			return SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpDeadline();
		}
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpBlockingTime) {
			return SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpBlockingTime();
		}
		if (editorKey == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpRepetition) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		SbWriteStep sbWriteStep = (SbWriteStep)semanticObject;
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.name == event.getAffectedEditor()) {
			sbWriteStep.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation == event.getAffectedEditor()) {
		...
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				if (event.getNewValue() instanceof SbStepPrecedenceRelation) {
		...
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.representedOperation == event.getAffectedEditor()) {
		...
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.interactionResource == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
		...
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpExecutionTime == event.getAffectedEditor()) {
		...
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpDeadline == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.EDIT) {
		...
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpBlockingTime == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.EDIT) {
		...
		if (SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpRepetition == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.EDIT) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			SbWriteStepPropertiesEditionPart basePart = (SbWriteStepPropertiesEditionPart)editingPart;
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.name)) {
			...
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_InputStepRelation().equals(msg.getFeature())  && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation))
				basePart.updateInputStepRelation();
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_OutputStepRelation().equals(msg.getFeature())  && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation))
				basePart.updateOutputStepRelation();
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_RepresentedOperation().equals(msg.getFeature()) && basePart != null && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.representedOperation))
				basePart.setRepresentedOperation((EObject)msg.getNewValue());
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_InteractionResource().equals(msg.getFeature()) && basePart != null && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.interactionResource))
				basePart.setInteractionResource((EObject)msg.getNewValue());
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpExecutionTime().equals(msg.getFeature()) && basePart != null && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpExecutionTime))
				basePart.setRtpExecutionTime((EObject)msg.getNewValue());
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpDeadline().equals(msg.getFeature()) && basePart != null && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpDeadline))
				basePart.setRtpDeadline((EObject)msg.getNewValue());
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpBlockingTime().equals(msg.getFeature()) && basePart != null && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpBlockingTime))
				basePart.setRtpBlockingTime((EObject)msg.getNewValue());
			if (SoftwareBehaviorPackage.eINSTANCE.getSbStep_RtpRepetition().equals(msg.getFeature()) && basePart != null && isAccessible(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpRepetition))
	...
	public boolean isRequired(Object key, int kind) {
		return key == SoftwareBehaviorViewsRepository.SbWriteStep.Properties.name;
	}
