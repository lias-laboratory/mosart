 ...
 * 
 */
public interface SbTimeTriggerPropertiesEditionPart {
	...
	/**
	 * @return the rtpReleaseTime
	 * 
	 */
	public EObject getRtpReleaseTime();

	/**
	 * Init the rtpReleaseTime
	 * @param settings the combo setting
	 */
	public void initRtpReleaseTime(EObjectFlatComboSettings settings);

	/**
	 * Defines a new rtpReleaseTime
	 * @param newValue the new rtpReleaseTime to set
	 * 
	 */
	...
	/**
	 * @return the rtpPeriodicity
	 * 
	 */
	public EObject getRtpPeriodicity();

	/**
	 * Init the rtpPeriodicity
	 * @param settings the combo setting
	 */
	public void initRtpPeriodicity(EObjectFlatComboSettings settings);

	/**
	 * Defines a new rtpPeriodicity
	 * @param newValue the new rtpPeriodicity to set
	 * 
	 */
