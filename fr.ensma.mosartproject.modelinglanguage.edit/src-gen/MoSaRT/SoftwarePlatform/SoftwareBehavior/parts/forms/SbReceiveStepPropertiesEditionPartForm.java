 ...
 * 
 */
public class SbReceiveStepPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SbReceiveStepPropertiesEditionPart {
	 ...
	 */
	public SbReceiveStepPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public SbReceiveStepPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(SoftwareBehaviorMessages.SbReceiveStepPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SbReceiveStepPropertiesEditionPartForm.this,
							SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.name, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createInputStepRelationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inputStepRelation = new ReferencesTable(getDescription(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.inputStepRelation, SoftwareBehaviorMessages.SbReceiveStepPropertiesEditionPart_InputStepRelationLabel), new ReferencesTableListener	() {
		...
		this.inputStepRelation.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.inputStepRelation, SoftwareBehaviorViewsRepository.FORM_KIND));
		...
		this.inputStepRelation.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.inputStepRelation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"inputStepRelation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.inputStepRelation,
	...
	protected void moveInputStepRelation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.inputStepRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		inputStepRelation.refresh();
	}
	...
	protected void removeFromInputStepRelation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.inputStepRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		inputStepRelation.refresh();
	}
	...
	protected Composite createOutputStepRelationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outputStepRelation = new ReferencesTable(getDescription(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.outputStepRelation, SoftwareBehaviorMessages.SbReceiveStepPropertiesEditionPart_OutputStepRelationLabel), new ReferencesTableListener	() {
		...
		this.outputStepRelation.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.outputStepRelation, SoftwareBehaviorViewsRepository.FORM_KIND));
		...
		this.outputStepRelation.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.outputStepRelation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutputStepRelation() {
		...
		"outputStepRelation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.outputStepRelation,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOutputStepRelation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.outputStepRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outputStepRelation.refresh();
	}
	...
	protected void removeFromOutputStepRelation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.outputStepRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outputStepRelation.refresh();
	}
	...
	protected Composite createRepresentedOperationFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		representedOperation = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.representedOperation, SoftwareBehaviorViewsRepository.FORM_KIND));
		...
		representedOperation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.representedOperation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRepresentedOperation()));
			}

		});
		representedOperation.setID(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.representedOperation);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.representedOperation, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createInteractionResourceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		interactionResource = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.interactionResource, SoftwareBehaviorViewsRepository.FORM_KIND));
		...
		interactionResource.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.interactionResource, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getInteractionResource()));
			}

		});
		interactionResource.setID(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.interactionResource);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.interactionResource, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpExecutionTimeSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		rtpExecutionTime.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpExecutionTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpExecutionTime.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpExecutionTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpExecutionTime.refresh();
			}
		});
		rtpExecutionTime.setID(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpExecutionTime);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpExecutionTime, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpDeadlineSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		rtpDeadline.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpDeadline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpDeadline.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpDeadline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpDeadline.refresh();
			}
		});
		rtpDeadline.setID(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpDeadline);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpDeadline, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpBlockingTimeSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		rtpBlockingTime.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpBlockingTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpBlockingTime.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpBlockingTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpBlockingTime.refresh();
			}
		});
		rtpBlockingTime.setID(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpBlockingTime);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpBlockingTime, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpRepetitionSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		rtpRepetition.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpRepetition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpRepetition.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbReceiveStepPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpRepetition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpRepetition.refresh();
			}
		});
		rtpRepetition.setID(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpRepetition);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbReceiveStep.Properties.rtpRepetition, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
