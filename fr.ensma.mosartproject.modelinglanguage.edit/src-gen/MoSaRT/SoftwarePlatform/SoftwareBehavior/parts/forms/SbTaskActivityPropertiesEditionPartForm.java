 ...
 * 
 */
public class SbTaskActivityPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SbTaskActivityPropertiesEditionPart {
	...
	protected SingleCompositionEditor rtpOffset;
	protected SingleCompositionEditor rtpPriority;
	protected SingleCompositionEditor rtpCriticality;
	protected SingleCompositionEditor rtpPreemptibility;
	protected SingleCompositionEditor rtpSelfSuspension;
	protected SingleCompositionEditor rtpBlockingTime;
	protected SingleCompositionEditor rtpResponseTime;
	 ...
	 */
	public SbTaskActivityPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public SbTaskActivityPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(sbTaskActivityStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.inputSquencingRelation) {
					return createInputSquencingRelationReferencesTable(widgetFactory, parent);
				}
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.outputSequencingRelation) {
					return createOutputSequencingRelationReferencesTable(widgetFactory, parent);
				}
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rootActionStep) {
					return createRootActionStepFlatComboViewer(parent, widgetFactory);
				}
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.representedTask) {
					return createRepresentedTaskFlatComboViewer(parent, widgetFactory);
				}
				...
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpOffset) {
					return createRtpOffsetSingleCompositionEditor(parent, widgetFactory);
				}
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPriority) {
					return createRtpPrioritySingleCompositionEditor(parent, widgetFactory);
				}
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpCriticality) {
					return createRtpCriticalitySingleCompositionEditor(parent, widgetFactory);
				}
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPreemptibility) {
					return createRtpPreemptibilitySingleCompositionEditor(parent, widgetFactory);
				}
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpSelfSuspension) {
					return createRtpSelfSuspensionSingleCompositionEditor(parent, widgetFactory);
				}
				...
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpResponseTime) {
					return createRtpResponseTimeSingleCompositionEditor(parent, widgetFactory);
				}
				...
				if (key == SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.actionSteps) {
					return createActionStepsTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(SoftwareBehaviorMessages.SbTaskActivityPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SbTaskActivityPropertiesEditionPartForm.this,
							SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.name, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTriggerFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		trigger = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.trigger, SoftwareBehaviorViewsRepository.FORM_KIND));
		widgetFactory.adapt(trigger);
		...
		trigger.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.trigger, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTrigger()));
			}

		});
		trigger.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.trigger);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.trigger, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createInputSquencingRelationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inputSquencingRelation = new ReferencesTable(getDescription(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.inputSquencingRelation, SoftwareBehaviorMessages.SbTaskActivityPropertiesEditionPart_InputSquencingRelationLabel), new ReferencesTableListener	() {
		...
		this.inputSquencingRelation.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.inputSquencingRelation, SoftwareBehaviorViewsRepository.FORM_KIND));
		this.inputSquencingRelation.createControls(parent, widgetFactory);
		this.inputSquencingRelation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.inputSquencingRelation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"inputSquencingRelation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.inputSquencingRelation,
	...
	protected void moveInputSquencingRelation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.inputSquencingRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		inputSquencingRelation.refresh();
	}
	...
	protected void removeFromInputSquencingRelation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.inputSquencingRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		inputSquencingRelation.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOutputSequencingRelationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outputSequencingRelation = new ReferencesTable(getDescription(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.outputSequencingRelation, SoftwareBehaviorMessages.SbTaskActivityPropertiesEditionPart_OutputSequencingRelationLabel), new ReferencesTableListener	() {
		...
		this.outputSequencingRelation.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.outputSequencingRelation, SoftwareBehaviorViewsRepository.FORM_KIND));
		this.outputSequencingRelation.createControls(parent, widgetFactory);
		this.outputSequencingRelation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.outputSequencingRelation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutputSequencingRelation() {
		...
		"outputSequencingRelation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.outputSequencingRelation,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOutputSequencingRelation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.outputSequencingRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outputSequencingRelation.refresh();
	}
	...
	protected void removeFromOutputSequencingRelation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.outputSequencingRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outputSequencingRelation.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createRootActionStepFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		rootActionStep = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rootActionStep, SoftwareBehaviorViewsRepository.FORM_KIND));
		widgetFactory.adapt(rootActionStep);
		...
		rootActionStep.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rootActionStep, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRootActionStep()));
			}

		});
		rootActionStep.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rootActionStep);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rootActionStep, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRepresentedTaskFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		representedTask = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.representedTask, SoftwareBehaviorViewsRepository.FORM_KIND));
		widgetFactory.adapt(representedTask);
		...
		representedTask.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.representedTask, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRepresentedTask()));
			}

		});
		representedTask.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.representedTask);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.representedTask, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpExecutionTimeSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		rtpExecutionTime.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpExecutionTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpExecutionTime.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpExecutionTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpExecutionTime.refresh();
			}
		});
		rtpExecutionTime.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpExecutionTime);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpExecutionTime, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpDeadlineSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		rtpDeadline.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpDeadline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpDeadline.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpDeadline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpDeadline.refresh();
			}
		});
		rtpDeadline.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpDeadline);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpDeadline, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpOffsetSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		//create widget
		rtpOffset = new SingleCompositionEditor(widgetFactory, parent, SWT.NONE);
		...
		rtpOffset.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpOffset, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpOffset.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpOffset, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpOffset.refresh();
			}
		});
		rtpOffset.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpOffset);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpOffset, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpPrioritySingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		//create widget
		rtpPriority = new SingleCompositionEditor(widgetFactory, parent, SWT.NONE);
		...
		rtpPriority.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPriority, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpPriority.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPriority, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpPriority.refresh();
			}
		});
		rtpPriority.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPriority);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPriority, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpCriticalitySingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		//create widget
		rtpCriticality = new SingleCompositionEditor(widgetFactory, parent, SWT.NONE);
		...
		rtpCriticality.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpCriticality, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpCriticality.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpCriticality, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpCriticality.refresh();
			}
		});
		rtpCriticality.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpCriticality);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpCriticality, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpPreemptibilitySingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		//create widget
		rtpPreemptibility = new SingleCompositionEditor(widgetFactory, parent, SWT.NONE);
		...
		rtpPreemptibility.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPreemptibility, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpPreemptibility.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPreemptibility, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpPreemptibility.refresh();
			}
		});
		rtpPreemptibility.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPreemptibility);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpPreemptibility, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpSelfSuspensionSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		//create widget
		rtpSelfSuspension = new SingleCompositionEditor(widgetFactory, parent, SWT.NONE);
		...
		rtpSelfSuspension.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpSelfSuspension, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpSelfSuspension.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpSelfSuspension, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpSelfSuspension.refresh();
			}
		});
		rtpSelfSuspension.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpSelfSuspension);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpSelfSuspension, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpBlockingTimeSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		rtpBlockingTime.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpBlockingTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpBlockingTime.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpBlockingTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpBlockingTime.refresh();
			}
		});
		rtpBlockingTime.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpBlockingTime);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpBlockingTime, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpResponseTimeSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		//create widget
		rtpResponseTime = new SingleCompositionEditor(widgetFactory, parent, SWT.NONE);
		...
		rtpResponseTime.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpResponseTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpResponseTime.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpResponseTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpResponseTime.refresh();
			}
		});
		rtpResponseTime.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpResponseTime);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpResponseTime, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpRepetitionSingleCompositionEditor(Composite parent, FormToolkit widgetFactory) {
		...
		rtpRepetition.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpRepetition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpRepetition.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this,  SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpRepetition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpRepetition.refresh();
			}
		});
		rtpRepetition.setID(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpRepetition);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.rtpRepetition, SoftwareBehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createActionStepsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.actionSteps = new ReferencesTable(getDescription(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.actionSteps, SoftwareBehaviorMessages.SbTaskActivityPropertiesEditionPart_ActionStepsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.actionSteps, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				actionSteps.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.actionSteps, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				actionSteps.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.actionSteps, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				actionSteps.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.actionSteps, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				actionSteps.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.actionSteps.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.actionSteps, SoftwareBehaviorViewsRepository.FORM_KIND));
		this.actionSteps.createControls(parent, widgetFactory);
		this.actionSteps.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbTaskActivityPropertiesEditionPartForm.this, SoftwareBehaviorViewsRepository.SbTaskActivity.Properties.actionSteps, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
