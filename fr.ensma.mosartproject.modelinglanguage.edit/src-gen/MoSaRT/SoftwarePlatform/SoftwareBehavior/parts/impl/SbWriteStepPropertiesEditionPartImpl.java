 ...
 * 
 */
public class SbWriteStepPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, SbWriteStepPropertiesEditionPart {
	 ...
	 * 
	 */
	public SbWriteStepPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(SoftwareBehaviorMessages.SbWriteStepPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.name, SoftwareBehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createInputStepRelationAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation, SoftwareBehaviorMessages.SbWriteStepPropertiesEditionPart_InputStepRelationLabel);		 
		...
		this.inputStepRelation.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation, SoftwareBehaviorViewsRepository.SWT_KIND));
		...
		this.inputStepRelation.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"inputStepRelation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation,
	...
	protected void moveInputStepRelation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		inputStepRelation.refresh();
	}
	...
	protected void removeFromInputStepRelation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.inputStepRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		inputStepRelation.refresh();
	}
	...
	protected Composite createOutputStepRelationAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation, SoftwareBehaviorMessages.SbWriteStepPropertiesEditionPart_OutputStepRelationLabel);		 
		...
		this.outputStepRelation.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation, SoftwareBehaviorViewsRepository.SWT_KIND));
		this.outputStepRelation.createControls(parent);
		this.outputStepRelation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutputStepRelation() {
		...
		"outputStepRelation", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOutputStepRelation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outputStepRelation.refresh();
	}
	...
	protected void removeFromOutputStepRelation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.outputStepRelation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outputStepRelation.refresh();
	}
	...
	protected Composite createRepresentedOperationFlatComboViewer(Composite parent) {
		...
		representedOperation = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.representedOperation, SoftwareBehaviorViewsRepository.SWT_KIND));
		...
		representedOperation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.representedOperation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRepresentedOperation()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.representedOperation, SoftwareBehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createInteractionResourceFlatComboViewer(Composite parent) {
		...
		interactionResource = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.interactionResource, SoftwareBehaviorViewsRepository.SWT_KIND));
		...
		interactionResource.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this, SoftwareBehaviorViewsRepository.SbWriteStep.Properties.interactionResource, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getInteractionResource()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.interactionResource, SoftwareBehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpExecutionTimeSingleCompositionEditor(Composite parent) {
		...
		rtpExecutionTime.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this,  SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpExecutionTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpExecutionTime.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this,  SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpExecutionTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpExecutionTime.refresh();
			}
		});
		rtpExecutionTime.setID(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpExecutionTime);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpExecutionTime, SoftwareBehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpDeadlineSingleCompositionEditor(Composite parent) {
		...
		rtpDeadline.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this,  SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpDeadline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpDeadline.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this,  SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpDeadline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpDeadline.refresh();
			}
		});
		rtpDeadline.setID(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpDeadline);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpDeadline, SoftwareBehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpBlockingTimeSingleCompositionEditor(Composite parent) {
		...
		rtpBlockingTime.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this,  SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpBlockingTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpBlockingTime.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this,  SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpBlockingTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpBlockingTime.refresh();
			}
		});
		rtpBlockingTime.setID(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpBlockingTime);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpBlockingTime, SoftwareBehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRtpRepetitionSingleCompositionEditor(Composite parent) {
		...
		rtpRepetition.addEditorListener(new SingleCompositionListener() {
			...
			public void edit() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this,  SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpRepetition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, null));				
				rtpRepetition.refresh();
			}
			
			public void clear() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SbWriteStepPropertiesEditionPartImpl.this,  SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpRepetition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.UNSET, null, null));
				rtpRepetition.refresh();
			}
		});
		rtpRepetition.setID(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpRepetition);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(SoftwareBehaviorViewsRepository.SbWriteStep.Properties.rtpRepetition, SoftwareBehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
