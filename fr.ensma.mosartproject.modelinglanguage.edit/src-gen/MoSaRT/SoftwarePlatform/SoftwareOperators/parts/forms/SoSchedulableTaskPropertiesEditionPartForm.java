 ...
 * 
 */
public class SoSchedulableTaskPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SoSchedulableTaskPropertiesEditionPart {
	 ...
	 */
	public SoSchedulableTaskPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public SoSchedulableTaskPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(soSchedulableTaskStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commWritingResources) {
					return createCommWritingResourcesReferencesTable(widgetFactory, parent);
				}
				if (key == SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commReadingResources) {
					return createCommReadingResourcesReferencesTable(widgetFactory, parent);
				}
				...
				if (key == SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.favoriteProcessors) {
					return createFavoriteProcessorsReferencesTable(widgetFactory, parent);
				}
				if (key == SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.runOnProcessors) {
					return createRunOnProcessorsReferencesTable(widgetFactory, parent);
				}
				if (key == SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.representedActivity) {
					return createRepresentedActivityFlatComboViewer(parent, widgetFactory);
				}
				if (key == SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.rtpMutualExclusionResourceUtilization) {
					return createRtpMutualExclusionResourceUtilizationTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(SoftwareOperatorsMessages.SoSchedulableTaskPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createProcessFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		process = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.process, SoftwareOperatorsViewsRepository.FORM_KIND));
		...
		process.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.process, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getProcess()));
			}

		});
		process.setID(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.process);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.process, SoftwareOperatorsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createMutualExclusionResourcesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.mutualExclusionResources = new ReferencesTable(getDescription(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.mutualExclusionResources, SoftwareOperatorsMessages.SoSchedulableTaskPropertiesEditionPart_MutualExclusionResourcesLabel), new ReferencesTableListener	() {
		...
		this.mutualExclusionResources.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.mutualExclusionResources, SoftwareOperatorsViewsRepository.FORM_KIND));
		...
		this.mutualExclusionResources.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.mutualExclusionResources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"mutualExclusionResources", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.mutualExclusionResources,
	...
	protected void moveMutualExclusionResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.mutualExclusionResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		mutualExclusionResources.refresh();
	}
	...
	protected void removeFromMutualExclusionResources(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.mutualExclusionResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		mutualExclusionResources.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createCommWritingResourcesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.commWritingResources = new ReferencesTable(getDescription(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commWritingResources, SoftwareOperatorsMessages.SoSchedulableTaskPropertiesEditionPart_CommWritingResourcesLabel), new ReferencesTableListener	() {
		...
		this.commWritingResources.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commWritingResources, SoftwareOperatorsViewsRepository.FORM_KIND));
		this.commWritingResources.createControls(parent, widgetFactory);
		this.commWritingResources.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commWritingResources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCommWritingResources() {
		...
		"commWritingResources", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commWritingResources,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveCommWritingResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commWritingResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		commWritingResources.refresh();
	}
	...
	protected void removeFromCommWritingResources(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commWritingResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		commWritingResources.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createCommReadingResourcesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.commReadingResources = new ReferencesTable(getDescription(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commReadingResources, SoftwareOperatorsMessages.SoSchedulableTaskPropertiesEditionPart_CommReadingResourcesLabel), new ReferencesTableListener	() {
		...
		this.commReadingResources.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commReadingResources, SoftwareOperatorsViewsRepository.FORM_KIND));
		this.commReadingResources.createControls(parent, widgetFactory);
		this.commReadingResources.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commReadingResources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCommReadingResources() {
		...
		"commReadingResources", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commReadingResources,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveCommReadingResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commReadingResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		commReadingResources.refresh();
	}
	...
	protected void removeFromCommReadingResources(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.commReadingResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		commReadingResources.refresh();
	}
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SoSchedulableTaskPropertiesEditionPartForm.this,
							SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.name, SoftwareOperatorsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createFavoriteProcessorsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.favoriteProcessors = new ReferencesTable(getDescription(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.favoriteProcessors, SoftwareOperatorsMessages.SoSchedulableTaskPropertiesEditionPart_FavoriteProcessorsLabel), new ReferencesTableListener	() {
		...
		this.favoriteProcessors.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.favoriteProcessors, SoftwareOperatorsViewsRepository.FORM_KIND));
		this.favoriteProcessors.createControls(parent, widgetFactory);
		this.favoriteProcessors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.favoriteProcessors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addFavoriteProcessors() {
		...
		"favoriteProcessors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.favoriteProcessors,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveFavoriteProcessors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.favoriteProcessors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		favoriteProcessors.refresh();
	}
	...
	protected void removeFromFavoriteProcessors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.favoriteProcessors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		favoriteProcessors.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createRunOnProcessorsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.runOnProcessors = new ReferencesTable(getDescription(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.runOnProcessors, SoftwareOperatorsMessages.SoSchedulableTaskPropertiesEditionPart_RunOnProcessorsLabel), new ReferencesTableListener	() {
		...
		this.runOnProcessors.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.runOnProcessors, SoftwareOperatorsViewsRepository.FORM_KIND));
		this.runOnProcessors.createControls(parent, widgetFactory);
		this.runOnProcessors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.runOnProcessors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addRunOnProcessors() {
		...
		"runOnProcessors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.runOnProcessors,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveRunOnProcessors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.runOnProcessors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		runOnProcessors.refresh();
	}
	...
	protected void removeFromRunOnProcessors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.runOnProcessors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		runOnProcessors.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createRepresentedActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		representedActivity = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.representedActivity, SoftwareOperatorsViewsRepository.FORM_KIND));
		widgetFactory.adapt(representedActivity);
		...
		representedActivity.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.representedActivity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRepresentedActivity()));
			}

		});
		representedActivity.setID(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.representedActivity);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.representedActivity, SoftwareOperatorsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRtpMutualExclusionResourceUtilizationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.rtpMutualExclusionResourceUtilization = new ReferencesTable(getDescription(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.rtpMutualExclusionResourceUtilization, SoftwareOperatorsMessages.SoSchedulableTaskPropertiesEditionPart_RtpMutualExclusionResourceUtilizationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.rtpMutualExclusionResourceUtilization, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				rtpMutualExclusionResourceUtilization.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.rtpMutualExclusionResourceUtilization, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				rtpMutualExclusionResourceUtilization.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.rtpMutualExclusionResourceUtilization, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				rtpMutualExclusionResourceUtilization.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.rtpMutualExclusionResourceUtilization, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				rtpMutualExclusionResourceUtilization.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.rtpMutualExclusionResourceUtilization.setHelpText(propertiesEditionComponent.getHelpContent(SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.rtpMutualExclusionResourceUtilization, SoftwareOperatorsViewsRepository.FORM_KIND));
		this.rtpMutualExclusionResourceUtilization.createControls(parent, widgetFactory);
		this.rtpMutualExclusionResourceUtilization.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SoSchedulableTaskPropertiesEditionPartForm.this, SoftwareOperatorsViewsRepository.SoSchedulableTask.Properties.rtpMutualExclusionResourceUtilization, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
