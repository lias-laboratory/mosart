...
/**
 * This is the item provider adapter for a {@link MoSaRT.RealTimeProperties.RtpHelperTypes.RtpFrequencyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RtpFrequencyTypeItemProvider
	 ...
	 * @generated
	 */
	public RtpFrequencyTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RtpFrequencyType_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RtpFrequencyType_unit_feature", "_UI_RtpFrequencyType_type"),
				 RtpHelperTypesPackage.Literals.RTP_FREQUENCY_TYPE__UNIT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RtpHelperTypesPackage.Literals.RTP_FREQUENCY_TYPE__VALUE);
		}
	...
	/**
	 * This returns RtpFrequencyType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RtpFrequencyType"));
	}
	...
	public String getText(Object object) {
		...
		try{
			RealVariable labelValue2 = ((RtpFrequencyType)object).getValue();
			if (labelValue2 !=null){
				labelValue = "value = ";
		...
		try{
			FrequencyUnits labelValue1 = ((RtpFrequencyType)object).getUnit();
			labelValue = labelValue.concat(", unit = "+labelValue1.toString());
		}catch(NullPointerException e) {}
		
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			//getString("_UI_RtpFrequencyType_type") :
			//getString("_UI_RtpFrequencyType_type") + " " + label;
				"malformed":
					label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RtpFrequencyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RtpHelperTypesPackage.Literals.RTP_FREQUENCY_TYPE__VALUE,
