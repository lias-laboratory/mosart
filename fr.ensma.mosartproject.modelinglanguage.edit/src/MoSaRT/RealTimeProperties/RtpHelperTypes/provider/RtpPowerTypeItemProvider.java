...
/**
 * This is the item provider adapter for a {@link MoSaRT.RealTimeProperties.RtpHelperTypes.RtpPowerType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RtpPowerTypeItemProvider
	 ...
	 * @generated
	 */
	public RtpPowerTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RtpPowerType_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RtpPowerType_unit_feature", "_UI_RtpPowerType_type"),
				 RtpHelperTypesPackage.Literals.RTP_POWER_TYPE__UNIT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RtpHelperTypesPackage.Literals.RTP_POWER_TYPE__VALUE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RtpPowerType"));
	}
	...
	public String getText(Object object) {
		PowerUnits labelValue1 = ((RtpPowerType)object).getUnit();
		RealVariable labelValue2 = ((RtpPowerType)object).getValue();
		...
		labelValue = ", unit = "+labelValue1.toString();
		
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			//getString("_UI_RtpPowerType_type") :
			//getString("_UI_RtpPowerType_type") + " " + label;
				"malformed":
					label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RtpPowerType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RtpHelperTypesPackage.Literals.RTP_POWER_TYPE__VALUE,
