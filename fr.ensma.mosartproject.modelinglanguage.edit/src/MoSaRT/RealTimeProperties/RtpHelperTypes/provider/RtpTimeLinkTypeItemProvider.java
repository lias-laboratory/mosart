...
import MoSaRT.SoftwarePlatform.SoftwareBehavior.provider.SbTaskActivityItemProvider;
...
public class RtpTimeLinkTypeItemProvider
	...
	public String getText(Object object) {
		RtpScheduleLinkType labelValue1 = ((RtpTimeLinkType)object).getScheduleLink();
		int labelValue2= ((RtpTimeLinkType)object).getJobNumber();
		SbTaskActivity labelValue3 = (SbTaskActivity) ((RtpTimeLinkType)object).getReferenceActivity();
		
		String labelValue = labelValue1.toString()+" ";
		if (labelValue2>0) labelValue=labelValue.concat(labelValue2+" execution(s) of ");
		
		SbTaskActivityItemProvider extItemProvider = new SbTaskActivityItemProvider(adapterFactory);
		
		labelValue = labelValue.concat(extItemProvider.getText(labelValue3));
