...
/**
 * This is the item provider adapter for a {@link MoSaRT.RealTimeProperties.RtpProtocolsAndPolicies.FullDuplexTransmissionMode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FullDuplexTransmissionModeItemProvider
	 ...
	 * @generated
	 */
	public FullDuplexTransmissionModeItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns FullDuplexTransmissionMode.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FullDuplexTransmissionMode"));
	}
	...
	public String getText(Object object) {
		String label = ((FullDuplexTransmissionMode)object).getModeType();
		return label == null || label.length() == 0 ?
			//getString("_UI_FullDuplexTransmissionMode_type") :
			//getString("_UI_FullDuplexTransmissionMode_type") + " " + label;
				"(FullDplx)":
					label+" "+"(FullDplx)";
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FullDuplexTransmissionMode.class)) {
