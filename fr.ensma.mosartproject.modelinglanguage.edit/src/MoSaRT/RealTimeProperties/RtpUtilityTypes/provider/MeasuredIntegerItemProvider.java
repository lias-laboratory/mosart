...
public class MeasuredIntegerItemProvider
	...
	public String getText(Object object) {
		...
		int label1 = ((MeasuredInteger)object).getValue();
		String label2 = ((MeasuredInteger)object).getUnknownValueName();
		if (label2 == null || label2.length()==0) label2="";
		EList<String> label3 = ((MeasuredInteger)object).getToolUsedDescriptions();
		EList<Double> label4 = ((MeasuredInteger)object).getAllOldValues();
