...
/**
 * This is the item provider adapter for a {@link MoSaRT.RealTimeProperties.RtpUtilityTypes.RealInterval} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RealIntervalItemProvider
	 ...
	 * @generated
	 */
	public RealIntervalItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RealInterval_delimiterMin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RealInterval_delimiterMin_feature", "_UI_RealInterval_type"),
				 RtpUtilityTypesPackage.Literals.REAL_INTERVAL__DELIMITER_MIN,
				 true,
				 false,
				 false,
	...
	protected void addBoundMinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RealInterval_boundMin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RealInterval_boundMin_feature", "_UI_RealInterval_type"),
				 RtpUtilityTypesPackage.Literals.REAL_INTERVAL__BOUND_MIN,
				 true,
				 false,
				 false,
	...
	protected void addBoundMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RealInterval_boundMax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RealInterval_boundMax_feature", "_UI_RealInterval_type"),
				 RtpUtilityTypesPackage.Literals.REAL_INTERVAL__BOUND_MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addDelimiterMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RealInterval_delimiterMax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RealInterval_delimiterMax_feature", "_UI_RealInterval_type"),
				 RtpUtilityTypesPackage.Literals.REAL_INTERVAL__DELIMITER_MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RealInterval"));
	}
	...
	public String getText(Object object) {
		...
		DelimiterType labelValue1 = ((RealInterval)object).getDelimiterMin();
		double labelValue2 = ((RealInterval)object).getBoundMin();
		double labelValue3 = ((RealInterval)object).getBoundMax();
		DelimiterType labelValue4 = ((RealInterval)object).getDelimiterMax();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RealInterval.class)) {
