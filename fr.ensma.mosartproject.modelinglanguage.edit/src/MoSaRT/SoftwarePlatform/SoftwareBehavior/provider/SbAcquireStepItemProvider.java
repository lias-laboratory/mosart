...
/**
 * This is the item provider adapter for a {@link MoSaRT.SoftwarePlatform.SoftwareBehavior.SbAcquireStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SbAcquireStepItemProvider
	 ...
	 * @generated
	 */
	public SbAcquireStepItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SbAcquireStep.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SbAcquireStep"));
	}
	...
	public String getText(Object object) {
		String label = ((SbAcquireStep)object).getName();
		return label == null || label.length() == 0 ?
			//getString("_UI_SbAcquireStep_type") :
			//getString("_UI_SbAcquireStep_type") + " " + label;
			"AcquireStep":
			"AcquireStep "+label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SbAcquireStep.class)) {
