...
/**
 * This is the item provider adapter for a {@link MoSaRT.SoftwarePlatform.SoftwareBehavior.SbActionStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SbActionStepItemProvider
	 ...
	 * @generated
	 */
	public SbActionStepItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SbActionStep"));
	}
	...
	public String getText(Object object) {
		String label = ((SbActionStep)object).getName();
		return label == null || label.length() == 0 ?
			//getString("_UI_SbActionStep_type") :
			//getString("_UI_SbActionStep_type") + " " + label;
			"ActionStep":
			"ActionStep "+label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SbActionStep.class)) {
