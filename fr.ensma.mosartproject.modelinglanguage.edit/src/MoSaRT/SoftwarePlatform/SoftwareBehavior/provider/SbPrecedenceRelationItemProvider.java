...
/**
 * This is the item provider adapter for a {@link MoSaRT.SoftwarePlatform.SoftwareBehavior.SbPrecedenceRelation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SbPrecedenceRelationItemProvider
	 ...
	 * @generated
	 */
	public SbPrecedenceRelationItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SbPrecedenceRelation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SbPrecedenceRelation"));
	}
	...
	public String getText(Object object) {
		String label = ((SbPrecedenceRelation)object).getName();
		return label == null || label.length() == 0 ?
			//getString("_UI_SbPrecedenceRelation_type") :
			//getString("_UI_SbPrecedenceRelation_type") + " " + label;
				"PrecedenceRelation":
					"PrecedenceRelation "+label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SbPrecedenceRelation.class)) {
