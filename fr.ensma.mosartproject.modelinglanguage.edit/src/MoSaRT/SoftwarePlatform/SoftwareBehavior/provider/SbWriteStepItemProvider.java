...
/**
 * This is the item provider adapter for a {@link MoSaRT.SoftwarePlatform.SoftwareBehavior.SbWriteStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SbWriteStepItemProvider
	 ...
	 * @generated
	 */
	public SbWriteStepItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SbWriteStep"));
	}
	...
	public String getText(Object object) {
		String label = ((SbWriteStep)object).getName();
		return label == null || label.length() == 0 ?
			//getString("_UI_SbWriteStep_type") :
			//getString("_UI_SbWriteStep_type") + " " + label;
				"WriteStep":
					"WriteStep "+label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SbWriteStep.class)) {
