...
public class ValidateActionForMoSaRTModelingLanguage extends ValidateAction {
	
	class EclipseResourcesUtil extends EditUIMarkerHelper
	  {
	    ...
	    {
	      //return "fr.ensma.mosartproject.modelinglanguage.perspective.mosartproblemmarker";
	    	return "fr.ensma.mosartproject.modelinglanguage.edit.mosartmlvalidationmarker";
	    }
