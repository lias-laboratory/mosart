...
/**
 * This is the item provider adapter for a {@link MoSaRT.RealTimeProperties.RtpProtocolsAndPolicies.SimpleTransmissionMode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleTransmissionModeItemProvider 
	 ...
	 * @generated
	 */
	public SimpleTransmissionModeItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SimpleTransmissionMode.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SimpleTransmissionMode"));
	}
	...
	public String getText(Object object) {
		String label = ((SimpleTransmissionMode)object).getModeType();
		return label == null || label.length() == 0 ?
			getString("_UI_SimpleTransmissionMode_type") :
			getString("_UI_SimpleTransmissionMode_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SimpleTransmissionMode.class)) {
			case RtpProtocolsAndPoliciesPackage.SIMPLE_TRANSMISSION_MODE__MODE_TYPE:
