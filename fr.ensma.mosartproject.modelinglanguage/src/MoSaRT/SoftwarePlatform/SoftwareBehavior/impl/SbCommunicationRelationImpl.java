...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sb Communication Relation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbCommunicationRelationImpl#getName <em>Name</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbCommunicationRelationImpl#getTargetSchedulingActivity <em>Target Scheduling Activity</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbCommunicationRelationImpl#getSourceSchedulingActivity <em>Source Scheduling Activity</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbCommunicationRelationImpl#getCommResource <em>Comm Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SbCommunicationRelationImpl extends EObjectImpl implements SbCommunicationRelation {
	/**
	...
	/**
	 * The cached value of the '{@link #getCommResource() <em>Comm Resource</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCommResource()
	 * @generated
	 * @ordered
	 */
	protected SoCommunicationResource commResource;
	 ...
	 * @generated
	 */
	protected SbCommunicationRelationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SoftwareBehaviorPackage.Literals.SB_COMMUNICATION_RELATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__NAME, oldName, name));
	}
	...
	public SbSchedulingActivity getTargetSchedulingActivity() {
		if (targetSchedulingActivity != null && targetSchedulingActivity.eIsProxy()) {
			...
			if (targetSchedulingActivity != oldTargetSchedulingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__TARGET_SCHEDULING_ACTIVITY, oldTargetSchedulingActivity, targetSchedulingActivity));
			}
		}
	...
	public NotificationChain basicSetTargetSchedulingActivity(SbSchedulingActivity newTargetSchedulingActivity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__TARGET_SCHEDULING_ACTIVITY, oldTargetSchedulingActivity, newTargetSchedulingActivity);
	...
	public void setTargetSchedulingActivity(SbSchedulingActivity newTargetSchedulingActivity) {
		if (newTargetSchedulingActivity != targetSchedulingActivity) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__TARGET_SCHEDULING_ACTIVITY, newTargetSchedulingActivity, newTargetSchedulingActivity));
	}
	...
	public SbSchedulingActivity getSourceSchedulingActivity() {
		if (sourceSchedulingActivity != null && sourceSchedulingActivity.eIsProxy()) {
			...
			if (sourceSchedulingActivity != oldSourceSchedulingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__SOURCE_SCHEDULING_ACTIVITY, oldSourceSchedulingActivity, sourceSchedulingActivity));
			}
		}
	...
	public NotificationChain basicSetSourceSchedulingActivity(SbSchedulingActivity newSourceSchedulingActivity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__SOURCE_SCHEDULING_ACTIVITY, oldSourceSchedulingActivity, newSourceSchedulingActivity);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSourceSchedulingActivity(SbSchedulingActivity newSourceSchedulingActivity) {
		if (newSourceSchedulingActivity != sourceSchedulingActivity) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__SOURCE_SCHEDULING_ACTIVITY, newSourceSchedulingActivity, newSourceSchedulingActivity));
	}
	 ...
	 * @generated
	 */
	public SoCommunicationResource getCommResource() {
		if (commResource != null && commResource.eIsProxy()) {
			InternalEObject oldCommResource = (InternalEObject)commResource;
			commResource = (SoCommunicationResource)eResolveProxy(oldCommResource);
			if (commResource != oldCommResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__COMM_RESOURCE, oldCommResource, commResource));
			}
		}
		return commResource;
	}
	 ...
	 * @generated
	 */
	public SoCommunicationResource basicGetCommResource() {
		return commResource;
	}
	 ...
	 * @generated
	 */
	public void setCommResource(SoCommunicationResource newCommResource) {
		SoCommunicationResource oldCommResource = commResource;
		commResource = newCommResource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__COMM_RESOURCE, oldCommResource, commResource));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__TARGET_SCHEDULING_ACTIVITY:
				if (targetSchedulingActivity != null)
					msgs = ((InternalEObject)targetSchedulingActivity).eInverseRemove(this, SoftwareBehaviorPackage.SB_SCHEDULING_ACTIVITY__INPUT_SQUENCING_RELATION, SbSchedulingActivity.class, msgs);
				return basicSetTargetSchedulingActivity((SbSchedulingActivity)otherEnd, msgs);
			case SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__SOURCE_SCHEDULING_ACTIVITY:
				if (sourceSchedulingActivity != null)
					msgs = ((InternalEObject)sourceSchedulingActivity).eInverseRemove(this, SoftwareBehaviorPackage.SB_SCHEDULING_ACTIVITY__OUTPUT_SEQUENCING_RELATION, SbSchedulingActivity.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__COMM_RESOURCE:
				if (resolve) return getCommResource();
				return basicGetCommResource();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__SOURCE_SCHEDULING_ACTIVITY:
				...
				return;
			case SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__COMM_RESOURCE:
				setCommResource((SoCommunicationResource)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__SOURCE_SCHEDULING_ACTIVITY:
				...
				return;
			case SoftwareBehaviorPackage.SB_COMMUNICATION_RELATION__COMM_RESOURCE:
				setCommResource((SoCommunicationResource)null);
				return;
		}
