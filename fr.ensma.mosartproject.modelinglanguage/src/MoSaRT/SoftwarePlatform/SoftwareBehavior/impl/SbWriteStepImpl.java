...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sb Write Step</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getInputStepRelation <em>Input Step Relation</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getOutputStepRelation <em>Output Step Relation</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getName <em>Name</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getRtpDeadline <em>Rtp Deadline</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getRtpExecutionTime <em>Rtp Execution Time</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getRtpBlockingTime <em>Rtp Blocking Time</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getRtpRepetition <em>Rtp Repetition</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getRepresentedOperation <em>Represented Operation</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getRepetition <em>Repetition</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getDeadline <em>Deadline</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getExecutionTime <em>Execution Time</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getBlockingTime <em>Blocking Time</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getInteractionResource <em>Interaction Resource</em>}</li>
 *   <li>{@link MoSaRT.SoftwarePlatform.SoftwareBehavior.impl.SbWriteStepImpl#getStepPredecessors <em>Step Predecessors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SbWriteStepImpl extends EObjectImpl implements SbWriteStep {
	/**
	...
	protected EClass eStaticClass() {
		return SoftwareBehaviorPackage.Literals.SB_WRITE_STEP;
	}
	...
	public EList<SbStepPrecedenceRelation> getInputStepRelation() {
		if (inputStepRelation == null) {
			inputStepRelation = new EObjectWithInverseResolvingEList<SbStepPrecedenceRelation>(SbStepPrecedenceRelation.class, this, SoftwareBehaviorPackage.SB_WRITE_STEP__INPUT_STEP_RELATION, SoftwareBehaviorPackage.SB_STEP_PRECEDENCE_RELATION__TARGET_STEP);
		}
	...
	public EList<SbStepPrecedenceRelation> getOutputStepRelation() {
		if (outputStepRelation == null) {
			outputStepRelation = new EObjectWithInverseResolvingEList<SbStepPrecedenceRelation>(SbStepPrecedenceRelation.class, this, SoftwareBehaviorPackage.SB_WRITE_STEP__OUTPUT_STEP_RELATION, SoftwareBehaviorPackage.SB_STEP_PRECEDENCE_RELATION__SOURCE_STEP);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetRtpDeadline(RtpDeadlineType newRtpDeadline, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_DEADLINE, oldRtpDeadline, newRtpDeadline);
	...
	public void setRtpDeadline(RtpDeadlineType newRtpDeadline) {
		if (newRtpDeadline != rtpDeadline) {
			...
			if (rtpDeadline != null)
				msgs = ((InternalEObject)rtpDeadline).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_DEADLINE, null, msgs);
			if (newRtpDeadline != null)
				msgs = ((InternalEObject)newRtpDeadline).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_DEADLINE, null, msgs);
			msgs = basicSetRtpDeadline(newRtpDeadline, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_DEADLINE, newRtpDeadline, newRtpDeadline));
	}
	...
	public NotificationChain basicSetRtpExecutionTime(RtpExecutionTimeType newRtpExecutionTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_EXECUTION_TIME, oldRtpExecutionTime, newRtpExecutionTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRtpExecutionTime(RtpExecutionTimeType newRtpExecutionTime) {
		if (newRtpExecutionTime != rtpExecutionTime) {
			...
			if (rtpExecutionTime != null)
				msgs = ((InternalEObject)rtpExecutionTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_EXECUTION_TIME, null, msgs);
			if (newRtpExecutionTime != null)
				msgs = ((InternalEObject)newRtpExecutionTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_EXECUTION_TIME, null, msgs);
			msgs = basicSetRtpExecutionTime(newRtpExecutionTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_EXECUTION_TIME, newRtpExecutionTime, newRtpExecutionTime));
	}
	...
	public NotificationChain basicSetRtpBlockingTime(RtpBlockingTimeType newRtpBlockingTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_BLOCKING_TIME, oldRtpBlockingTime, newRtpBlockingTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRtpBlockingTime(RtpBlockingTimeType newRtpBlockingTime) {
		if (newRtpBlockingTime != rtpBlockingTime) {
			...
			if (rtpBlockingTime != null)
				msgs = ((InternalEObject)rtpBlockingTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_BLOCKING_TIME, null, msgs);
			if (newRtpBlockingTime != null)
				msgs = ((InternalEObject)newRtpBlockingTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_BLOCKING_TIME, null, msgs);
			msgs = basicSetRtpBlockingTime(newRtpBlockingTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_BLOCKING_TIME, newRtpBlockingTime, newRtpBlockingTime));
	}
	...
	public NotificationChain basicSetRtpRepetition(RtpRepetitionType newRtpRepetition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_REPETITION, oldRtpRepetition, newRtpRepetition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRtpRepetition(RtpRepetitionType newRtpRepetition) {
		if (newRtpRepetition != rtpRepetition) {
			...
			if (rtpRepetition != null)
				msgs = ((InternalEObject)rtpRepetition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_REPETITION, null, msgs);
			if (newRtpRepetition != null)
				msgs = ((InternalEObject)newRtpRepetition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_REPETITION, null, msgs);
			msgs = basicSetRtpRepetition(newRtpRepetition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_REPETITION, newRtpRepetition, newRtpRepetition));
	}
	...
	public Operation getRepresentedOperation() {
		if (representedOperation != null && representedOperation.eIsProxy()) {
			...
			if (representedOperation != oldRepresentedOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SoftwareBehaviorPackage.SB_WRITE_STEP__REPRESENTED_OPERATION, oldRepresentedOperation, representedOperation));
			}
		}
	...
	public void setRepresentedOperation(Operation newRepresentedOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__REPRESENTED_OPERATION, oldRepresentedOperation, representedOperation));
	}
	...
	public SoInteractionResource getInteractionResource() {
		if (interactionResource != null && interactionResource.eIsProxy()) {
			...
			if (interactionResource != oldInteractionResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SoftwareBehaviorPackage.SB_WRITE_STEP__INTERACTION_RESOURCE, oldInteractionResource, interactionResource));
			}
		}
	...
	public void setInteractionResource(SoInteractionResource newInteractionResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareBehaviorPackage.SB_WRITE_STEP__INTERACTION_RESOURCE, oldInteractionResource, interactionResource));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SoftwareBehaviorPackage.SB_WRITE_STEP__INPUT_STEP_RELATION:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getInputStepRelation()).basicAdd(otherEnd, msgs);
			case SoftwareBehaviorPackage.SB_WRITE_STEP__OUTPUT_STEP_RELATION:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_DEADLINE:
				return basicSetRtpDeadline(null, msgs);
			case SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_EXECUTION_TIME:
				return basicSetRtpExecutionTime(null, msgs);
			case SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_BLOCKING_TIME:
				return basicSetRtpBlockingTime(null, msgs);
			case SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_REPETITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SoftwareBehaviorPackage.SB_WRITE_STEP__NAME:
				return getName();
			case SoftwareBehaviorPackage.SB_WRITE_STEP__RTP_DEADLINE:
			...
			case SoftwareBehaviorPackage.SB_WRITE_STEP__REPRESENTED_OPERATION:
				if (resolve) return getRepresentedOperation();
				return basicGetRepresentedOperation();
			case SoftwareBehaviorPackage.SB_WRITE_STEP__REPETITION:
				if (resolve) return getRepetition();
				return basicGetRepetition();
			case SoftwareBehaviorPackage.SB_WRITE_STEP__DEADLINE:
				if (resolve) return getDeadline();
				return basicGetDeadline();
			case SoftwareBehaviorPackage.SB_WRITE_STEP__EXECUTION_TIME:
				if (resolve) return getExecutionTime();
				return basicGetExecutionTime();
			case SoftwareBehaviorPackage.SB_WRITE_STEP__BLOCKING_TIME:
				if (resolve) return getBlockingTime();
				return basicGetBlockingTime();
			case SoftwareBehaviorPackage.SB_WRITE_STEP__INTERACTION_RESOURCE:
				if (resolve) return getInteractionResource();
				return basicGetInteractionResource();
			case SoftwareBehaviorPackage.SB_WRITE_STEP__STEP_PREDECESSORS:
