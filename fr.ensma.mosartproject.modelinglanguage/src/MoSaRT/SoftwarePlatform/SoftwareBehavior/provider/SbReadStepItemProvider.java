...
/**
 * This is the item provider adapter for a {@link MoSaRT.SoftwarePlatform.SoftwareBehavior.SbReadStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SbReadStepItemProvider 
	 ...
	 * @generated
	 */
	public SbReadStepItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SbReadStep"));
	}
	...
	public String getText(Object object) {
		String label = ((SbReadStep)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SbReadStep_type") :
			getString("_UI_SbReadStep_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SbReadStep.class)) {
