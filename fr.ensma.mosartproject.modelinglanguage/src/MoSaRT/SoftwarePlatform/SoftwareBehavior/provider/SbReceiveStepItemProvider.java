...
/**
 * This is the item provider adapter for a {@link MoSaRT.SoftwarePlatform.SoftwareBehavior.SbReceiveStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SbReceiveStepItemProvider 
	 ...
	 * @generated
	 */
	public SbReceiveStepItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SbReceiveStep.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SbReceiveStep"));
	}
	...
	public String getText(Object object) {
		String label = ((SbReceiveStep)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SbReceiveStep_type") :
			getString("_UI_SbReceiveStep_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SbReceiveStep.class)) {
